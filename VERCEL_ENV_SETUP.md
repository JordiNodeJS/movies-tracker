...
```
postgresql://neondb_owner:npg_PDx78KApEjVU@ep-aged-night-ab7l7nwr.eu-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require&options=-csearch_path%3D%22movies-tracker%22
```
